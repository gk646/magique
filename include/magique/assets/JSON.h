#ifndef MAGEQUEST_JSON_H
#define MAGEQUEST_JSON_H
...
//===============================================
// ................................................................................
// This module allows to import and export json using the glaze library
// Refer to https://stephenberry.github.io/glaze/json/ for more info on how to use
//
// IMPORTANT: If you define custom parse/serialization rules etc. they need to be included BEFORE you call the glz method
// ................................................................................
...
namespace magique
{
    inline const char* GetErrStr(const glz::error_ctx& ec)
    {
        switch (ec.ec)
        {
    ...
    bool ImportJSON(Asset asset, T& data)
    {
        ...
        if (ec)
        {
            LOG_ERROR("Failed to import JSON %s: %s at position %d", asset.getFileName(), GetErrStr(ec),
                      (int)ec.location);
            return false;
        }
        else
        {
            LOG_INFO("Successfully imported JSON");
        }
        return true;
    }
} // namespace magique

#endif //MAGEQUEST_JSON_H