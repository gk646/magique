...
static int FindAssetPos(const std::vector<Asset>& assets, const char* name)
{
    int low = 0;
...
static int FindDirectoryPos(const std::vector<Asset>& assets, const char* name, const int size)
{
    int low = 0;
    int high = static_cast<int>(assets.size());
