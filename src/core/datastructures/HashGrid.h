...
public:
    ...
    void getGridIDs(std::array<int16_t, 4>& gridIDs, float x, float y, float width, float height) const noexcept
    {
        ...
        if (topLeftGridX == bottomRightGridX && topLeftGridY == bottomRightGridY) [[LIKELY]]
        {
