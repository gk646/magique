...
namespace magique
{
    void SetScript(const EntityID entity, EntityScript* script)
    {
        ...
        {
            ASSERT(entity < 1000, "Sanity check! If you have more than 1000 entity types kudos!");
    ...
    {
        ASSERT(global::SCRIPT_DATA.scripts.size() > entity, "No script registered for this type! Did you call SetScript()?");
        ASSERT(global::SCRIPT_DATA.scripts[entity] != global::SCRIPT_DATA.defaultScript,
