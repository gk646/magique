...
elseif (MSVC)
    ...
    set(CMAKE_CXX_FLAGS_RELEASE "${CMAKE_CXX_FLAGS_RELEASE} /Zi /O2 /Ob3 /GA /Gw /GL /EHsc /GR- /GF")
    set(CMAKE_EXE_LINKER_FLAGS_RELEASE "${CMAKE_EXE_LINKER_FLAGS_RELEASE} /Zi /LTCG /OPT:REF /OPT:ICF")
