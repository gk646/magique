...
function(copy_shared_library source)
    add_custom_command(TARGET magique POST_BUILD COMMAND ${CMAKE_COMMAND} -E copy_if_different
            "${source}"
            ${CMAKE_BINARY_DIR})
    message(STATUS "Copied dynamic libraries to the root of the build directory. Adjust if your executable is somewhere else")
endfunction()

# Link against the GameNetworkingSockets or the Steam SDK (and platform specific libs)
if (MAGIQUE_STEAM_INTEGRATION)
    if (WIN32)
        target_link_libraries(magique PRIVATE winmm ${MAGIQUE_BINARY_DIR}/win64/steam_api64)
