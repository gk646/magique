...
if (MAGIQUE_STEAM)
    if (WIN32)
        target_link_libraries(magique PRIVATE ${MAGIQUE_BINARY_DIR}/win64/steam_api64.lib)
...
elseif (MAGIQUE_LAN)
    if (WIN32)
        target_link_libraries(magique PRIVATE ${MAGIQUE_BINARY_DIR}/win64/GameNetworkingSockets.lib)
...
if (WIN32)
    if (CMAKE_HOST_SYSTEM_NAME STREQUAL "Linux")
        target_link_libraries(magique PUBLIC -lstdc++exp)
    endif ()
